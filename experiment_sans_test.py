...
class RememberBest(object):
    ...
    def remember_epoch(self, epochs_df, model, optimizer, class_acc):
        """
        ...
        #     th.save(model, 'C:\\Users\\cfcoo\\Desktop\\results/S{}/{}_{}model{}_{}.pt'.format(subject_id,
        #                                                                                        data_type,
        #                                                                                        model_type, 
        #                                                                                        
        #                                                                                        model_number))
        ...
        if current_val <= self.lowest_val:
            ...
            log.info("New best {:s}: {:5f}".format(self.column_name,
                                                   current_val))
            log.info("")
            # th.save(model, f"C:\\Users\\cfcoo\\Desktop\\results/S{subject_id}/{data_type}_{model_type}model_{model_number}.pt")
            # log.info("")
...
class Experiment(object):
    ...
    def __init__(self, model, train_set, valid_set, test_set,
                 ...
                 run_after_early_stop, model_loss_function=None, 
